                    ...
                    <form id="form-create" action="{{ route('user.store')}}" method="post"  class="needs-validation" novalidate>
                        ...
                        <div class="row gy-4">
                            ...
                            <div class="col-sm-6 col-xs-6">
                                ...
                                <input type="text" class="form-control py-11 @error('employment_type') is-invalid @enderror"  value="{{ old('employment_type', '') }}"  name="employment_type" id="employment_type" placeholder="Enter Employment Type">
                            ...
                            <div class="col-sm-6 col-xs-6">
                                ...
                                <input type="date" class="form-control py-11 @error('expectance_date') is-invalid @enderror"  value="{{ old('expectance_date', '') }}"  name="expectance_date" id="expectance_date" placeholder="">
                            ...
                            <div class="col-sm-6 col-xs-6">
                                ...
                                <input type="date" class="form-control py-11 @error('actual_date') is-invalid @enderror"  value="{{ old('actual_date', '') }}"  name="actual_date" id="actual_date" placeholder="">
                            ...
                            <div class="col-sm-6 col-xs-6">
                                ...
                                <input type="text" class="form-control py-11 @error('recruiter') is-invalid @enderror"  value="{{ old('recruiter', '') }}"  name="recruiter" id="recruiter" placeholder="Enter Recruiter">
                            ...
                            {{-- <div class="col-sm-6 col-xs-6">
                                ...
                                <input type="text" class="form-control py-11 @error('offer_revoke') is-invalid @enderror"  value="{{ old('offer_revoke', '') }}"  name="offer_revoke" id="offer_revoke" placeholder="Enter Offer Revoke">
